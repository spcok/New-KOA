    ...
    <div className="space-y-6 max-w-[1600px] mx-auto font-sans pb-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-widest">Users, Roles & Preferences</p>
        </div>
      </div>
      ...
      <div className="bg-[#0F1117] rounded-3xl border border-slate-800/80 p-12 text-center shadow-2xl flex flex-col items-center">
        ...
        <p className="text-sm text-slate-400 mt-2 font-bold max-w-md mx-auto">The Settings module for configuring RBAC, operational lists, and system preferences is under development.</p>
      </div>
    </div>
  );
}
